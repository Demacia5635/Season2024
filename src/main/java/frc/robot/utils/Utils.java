...
public class Utils {
  ...
  private static double shootDistance[] = {1.38, 2,    2.3, 2.5, 2.8,   3,    3.3,  3.5};
  private static double shootAngle[] =    {58,   51.5, 46,  41, 40, 39, 38.5, 37.25};
  private static double shootVelocity[] = {13.5, 13.5, 14.5,15, 15, 15, 14.8, 15.25};
